...
7. **CI**：golangci-lint + 全部门禁 + release 构建脚本（jira-cli 模式：scripts/build-release.sh 交叉编译 6 平台 + checksums.txt + tag 版本门禁；用户指定参考 jira-cli，2026-06-11 已落 .github/workflows/{ci,release}.yml）
