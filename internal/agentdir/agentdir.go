...
// asset type projects for claude and codex (docs/reference/adapter-conformance.md §2).
...
// writes must stay inside it (docs/reference/security-contract.md §3).
